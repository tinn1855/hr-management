...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/L2cjp2NqxY)
...
```sh
npx nx serve hr-management
```

To create a production bundle:

```sh
npx nx build hr-management
```

To see all available targets to run for a project, run:

```sh
npx nx show project hr-management
```
